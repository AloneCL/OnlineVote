...
<form method="post" action="submitLogin" class="form center" onsubmit="return checkForm()">
    <div class="login">
        <div class="login_center">
            <div class="login_top">
                <div class="left fl">会员登录</div>
                <div class="right fr">
                    您还不是我们的会员？<a href="userRegister" target="_self">立即注册</a>
                </div>
                <div class="clear"></div>
...
<script type="text/javascript">
    ...
    function flushValidateCode() {
        ...
        validateImgObject.src = "${pageContext.request.contextPath }/getValidate?time="
            + new Date();
    }
    /*校验验证码输入是否正确*/
